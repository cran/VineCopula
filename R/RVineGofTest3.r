RVineGofTest<-function(data,RVM,method="White",statistic="CvM",B=200,alpha=2)
{
	...
	else if(statistic=="Anderson-Darling") statistic="AD"
	...
	{
		if(statistic=="AD") stop("The Anderson-Darling statistic is not available for the empirical copula process based goodness-of-fit tests.")
